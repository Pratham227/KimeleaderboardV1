...
export const EMPLOYEES_RAW = [                                                                                                                                                                                                
  ...
  { name: 'Shruti Singh',        email: 'shruti@kimeedu.co.in', gender: 'Female',   branch: 'Mumbai', lead: 'Aditya Maithani',  designation: 'Executive-Business Development',          tenure: 4, joiningDate: '4/01/2026' },
  ...
  {name : 'Sujit Pal',        email:' sujita.p@kimeedu.co.in ',  gender: 'Male' ,   branch : 'Pune',  lead: 'Amit',             designation: 'Executive-Business Development',          tenure: 2, joiningDate: '6/1/2026' },
